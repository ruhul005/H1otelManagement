...
public class Person{
	...
	public Person(String nameF,String nidF,String addressF,String phoneF,String roomF,String daysToRentF,int daysF,double totalCoast) {
		this.nameF=nameF ;
		this.nidF=nidF;
	...
	public String toString(){
		return nameF + ", " + nidF + ", " + addressF+","+phoneF+","+roomF+","+daysToRentF+","+daysF+","+totalCoastF;
	}
}
